...
数式画像または入力コードからTeX Sauce形式のコードブロックや解説を生成するWebアプリケーションです。
...
### v1.9.0
- 入力方法を「画像」と「コード」から選べるタブを追加。
- LaTeX、TeX Sauce、Markdownなどのコードを貼り付け、画像なしで解答を生成できるように変更。

### v1.8.10
- 生成結果のコード選択色を鮮やかな青へ変更し、黒背景での視認性を向上。

### v1.8.9
- 生成結果のコードをドラッグ選択した際の背景色を濃くし、選択範囲を判別しやすく改善。
